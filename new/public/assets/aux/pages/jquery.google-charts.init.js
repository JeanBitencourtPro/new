...
//        $this.createBarStackChart($('#bar-stacked-chart')[0], bar_stacked_data, ['#1ea69a','#348cd4', '#45bbe0', '#8892d6']);
        ...
        var pie_data = [
            ['Task', 'Hours per Day'],
            ['Livraria', 70],
            ['Áudio e Instrumentos Musicais', 15],
            ['Eletrônicos e Eletrodomésticos',  24],
            ['Informática e Tecnologia', 36],
            ['Outros', 40]
        ];
...
//        $this.createDonutChart($('#donut-chart')[0], pie_data, ['#188ae2', '#4bd396', '#f9c851', '#f5707a', '#6b5fb5']);
        ...
        var sliced_Data = [
            ...
            ['Livraria', 90],
            ['Áudio e Instrumentos Musicais', 46],
            ['Eletrônicos e Eletrodomésticos', 30],
            ['Informática e Tecnologia', 38],
            ['Outros', 70]
        ];
